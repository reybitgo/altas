...
CREATE TABLE packages (
  ...
  package_pv_rate           DECIMAL(5,2)     NOT NULL DEFAULT 100.00 COMMENT 'Percentage of entry fee that becomes package PV',
...
CREATE TABLE users (
  ...
  -- PV-centered architecture (Phase 1)
  ...
  personal_pv       DECIMAL(14,2) NOT NULL DEFAULT 0.00 COMMENT 'Personal sales PV',
  group_pv          DECIMAL(14,2) NOT NULL DEFAULT 0.00 COMMENT 'Group sales PV from downline',
  total_package_pv  DECIMAL(14,2) NOT NULL DEFAULT 0.00 COMMENT 'Total package PV generated by member',
