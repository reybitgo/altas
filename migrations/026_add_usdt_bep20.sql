-- ============================================================
--  MIGRATION 026: Add USDT BEP20 + rename TRC20 payout columns
--  Run: mysql -u USER -p DATABASE < migrations/026_add_usdt_bep20.sql
-- ============================================================

-- 1. Rename the legacy TRC20 address column to be explicit (idempotent)
SET @rename_col = (
...
-- 3. Rename legacy TRC20 payout columns (idempotent via MariaDB/MySQL behavior)
...
-- 4. Add BEP20 payout columns if they do not exist yet
...
-- 5. Expand payout_method ENUM to use usdt_trc20 and usdt_bep20
