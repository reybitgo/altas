      ...
      <div class="col-12 col-lg-6 d-flex flex-column gap-3">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form method="POST" action="<?= APP_URL ?>/?page=admin_manual_reset" class="m-0" id="manualResetForm">
              <?= csrf_field() ?>
              <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" name="trigger_dfi" id="triggerDfi" value="1">
                <label class="form-check-label" for="triggerDfi" style="font-size:.8rem;">
                  Also trigger DFI payout now
                </label>
              </div>
