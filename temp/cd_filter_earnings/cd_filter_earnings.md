...
**Commissions are blocked only when the _newly-placed member_ (source) has a CD-sourced registration.** The check is purely source-side — it looks at how the person being registered/placed paid, not at the earner's CD status.
